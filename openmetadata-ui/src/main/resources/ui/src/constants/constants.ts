...
export const ROUTES = {
  ...
  GOVERNANCE_POLICY_DETAILS: `/governance-policies/${PLACEHOLDER_ROUTE_FQN}`,
  GOVERNANCE_POLICY_VERSION: `/governance-policies/${PLACEHOLDER_ROUTE_FQN}/versions/${PLACEHOLDER_ROUTE_VERSION}`,
